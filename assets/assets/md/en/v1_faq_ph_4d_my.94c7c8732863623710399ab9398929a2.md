...
* StepPot's event uses the publicly announced 4D Lotto results to determine winning entries.
...
A. Draws are held every Monday, Wednesday, and Friday at 9:00 PM (GMT+8), based on the officially announced 4D Lotto results.
...
A. The reward will be divided equally. (e.g., If the reward amount is RM6 and there are 2 winners, each will receive RM3)
...
A. Make sure you have granted Motion & Fitness / Health app permissions. StepPot does not store or share your health data.
